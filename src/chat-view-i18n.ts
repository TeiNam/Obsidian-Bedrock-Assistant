...
export const VIEW_I18N = {
  en: {
    ...
    decisionIntro:
      "Approved decisions are merged into the ledger note. Values you edited there are kept; only empty fields are filled.",
    ...
    triageIntro:
      "Approved notes are renamed, moved, and tagged. Links are updated automatically. Notes whose target name already exists are skipped.",
...
${content}`,
  ...
  ko: {
    ...
    decisionIntro:
      "승인한 결정은 원장 노트에 병합됩니다. 원장에서 직접 고친 값은 유지되고 빈 칸만 채워집니다.",
    ...
    triageIntro:
      "승인한 노트는 이름이 바뀌고 이동되며 태그가 붙습니다. 링크는 자동으로 갱신됩니다. 대상 이름이 이미 있는 노트는 건너뜁니다.",
...
${content}`,
  ...
  ja: {
    ...
    decisionIntro:
      "承認した決定は台帳ノートに統合されます。台帳で直接編集した値は保持され、空欄のみ埋められます。",
    ...
    triageTitle: "Inbox整理",
    triageIntro:
      "承認したノートは名前が変更・移動され、タグが付きます。リンクは自動更新されます。移動先の名前が既にある場合はスキップします。",
